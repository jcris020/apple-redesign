            ...
            <main className="grid grid-cols-1 lg:grid-cols-9">
                    ...
                    <div className="mx-4 divide-y divide-gray-300 rounded-md border border-gray-300 p-4 lg:ml-14">
                        <div className="space-y-2 pb-3">
                            ...
                            <p className="text-sm tex-gray-600">
                                We've accepted your order, and we're getting it ready. Come back to this page for updates on your shiment status.
                            </p>
                        </div>
                        <div className="pt-3 text-sm">
                            <p className="font-medium text-gray-600">
                                Other tracking numbner:
                            </p>
                            <p>CNB21441622</p>
                        </div>
                    </div>
                ...
                {mounted && (
                    <section className="overflow-y-scroll border-y border-l border-gray-300 bg-[#FAFAFA] lg:order-2 lg:col-span-4 lg:h-screen lg:border-y-0">
                        ...
                        {/* If showOrderSummaryCondition is true show order summary drop down section */}
                        {showOrderSummaryCondition && (
